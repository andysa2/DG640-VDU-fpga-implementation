...
port (
	clk_in				: in  STD_LOGIC;											-- Pixel clock in from "clock_system"
	-- Global Interface
	haddr_cnt_out		: out STD_LOGIC_VECTOR(C_CNT_WIDTH-1 downto 0);	-- Horisontal address
	vaddr_cnt_out		: out STD_LOGIC_VECTOR(C_CNT_WIDTH-1 downto 0);	-- Vertiacl address
	-- VGA Interface
...
begin
	if(clk_in = '1' and clk_in'event)then
		haddr_cnt_out	<= STD_LOGIC_VECTOR(haddr_cnt);	-- Horisontal address
